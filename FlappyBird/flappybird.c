...
int main()                                    // Main function
{
  ...
  while(1)
  {
    ...
    for(int d = 0; d < oledc_getWidth()+7; d++)
    {
      //draw pipes
      int pipeWidth = 8;
      if(d > oledc_getWidth()) pipeWidth = 8 - d + oledc_getWidth();
      ...
      bird = bird + speed / 10;
      speed = speed - 6;
      if(bird > oledc_getHeight()-18) bird = oledc_getHeight()-18;
      ...
      //draw bird
      oledc_fillRect(10,oledc_getHeight()-((int) bird),5,5,YELLOWORANGE);
      ...
      pause(30);
      oledc_fillRect(10,oledc_getHeight()-((int) bird),5,5,BLACK);
